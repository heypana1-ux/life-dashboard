...
export function computeAchievements(data: AppData, history: DayScore[]): Achievement[] {
  ...
  const defs: Omit<Achievement, "unlocked">[] = [
    ...
    { id: "gym100", title: "Centurion", description: "Log 100 workouts", icon: "🦾", current: workouts, target: 100 },
    ...
    { id: "journal100", title: "Storyteller", description: "Write 100 journal entries", icon: "✍️", current: journal, target: 100 },
    { id: "streak100", title: "Century", description: "100-day activity streak", icon: "💯", current: Math.min(longest, 100), target: 100 },
    { id: "review4", title: "Reflective", description: "Complete 4 weekly reviews", icon: "🧭", current: data.weeklyReviews.length, target: 4 },
