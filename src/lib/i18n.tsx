...
const DE: Record<string, string> = {
  ...
  "Where you're headed": "Wohin du willst",
  private: "privat",
  "Wellbeing & body": "Wohlbefinden & Körper",
  "Strength & cardio": "Kraft & Ausdauer",
  "Creative board": "Kreativ-Board",
  ...
  "Up next today": "Als Nächstes heute",
  "{n} open": "{n} offen",
  "Not written yet": "Noch nicht geschrieben",
  "Still open · counts toward the score": "Noch offen · zählt zum Score",
  "{area} is pulling the score down": "{area} zieht den Score nach unten",
  "It sits at {n} while your other areas average higher. See what moves it.": "Er liegt bei {n}, deine anderen Bereiche im Schnitt höher. Schau, was ihn bewegt.",
  "{n} overlapping days": "{n} überlappende Tage",
  "Strongest pairs in your data": "Stärkste Paare in deinen Daten",
  "Pearson r over days where both values exist. Pairs with fewer than 3 shared days are hidden.": "Pearson-r über Tage, an denen beide Werte existieren. Paare mit weniger als 3 gemeinsamen Tagen sind ausgeblendet.",
  "{a} of {b} answered": "{a} von {b} beantwortet",
  "About": "Über",
  "you": "dich",
  "{n} items unlocked": "{n} Teile freigeschaltet",
  "Random": "Zufall",
  "Character preview — rendered from your avatar config.": "Charakter-Vorschau — aus deiner Avatar-Konfiguration erzeugt.",
  "{n} day streak": "{n} Tage Serie",
  "{n} unlocked": "{n} freigeschaltet",
  "{n} players": "{n} Spieler",
  "{n} running": "{n} laufend",
  "On days with the condition, {metric} was on average": "An Tagen mit der Bedingung war {metric} im Schnitt",
  "~{n} pts/day": "~{n} Pkt./Tag",
  "Reward (lead)": "",
  ...
  Configure: "Anpassen",
  "Choose what you'd like to quick-log. You can change this anytime with the gear icon.":
    "Wähle, was du schnell eintragen möchtest. Du kannst das jederzeit über das Zahnrad ändern.",
  "Speak or type anything — the AI logs it": "Sprich oder tippe irgendetwas — die KI trägt es ein",
  "Add mood & energy": "Stimmung & Energie hinzufügen",
  "Done or avoided — plus optional mood & energy": "Erledigt oder vermieden — plus optional Stimmung & Energie",
  "Wellbeing, water, weight": "Wohlbefinden, Wasser, Gewicht",
  "Rate your life areas": "Bewerte deine Lebensbereiche",
  "Bought something today?": "Heute etwas gekauft?",
  "Trained today?": "Heute trainiert?",
  Entry: "Eintrag",
  "What's on your mind?": "Was beschäftigt dich?",
  "e.g. Groceries": "z. B. Lebensmittel",
  "e.g. Running": "z. B. Laufen",
  ...
  // --- Profile & accents ---
  "in the shop": "im Shop",
  "How you show up — to yourself and others.": "Wie du dich zeigst — dir und anderen.",
  "Public profile": "Öffentliches Profil",
  "When on, people you share a scoreboard with can open this card (name, level, titles, achievements). Never your logs.":
    "Wenn aktiv, können Personen aus deinem Scoreboard diese Karte öffnen (Name, Level, Titel, Erfolge). Niemals deine Einträge.",
  Identity: "Identität",
  "Display name (nickname)": "Anzeigename (Spitzname)",
  "Remove photo": "Foto entfernen",
  "Personal details": "Persönliche Angaben",
  Lvl: "Lvl",
  "Unlocked themes": "Freigeschaltete Themes",
  Anonymous: "Anonym",
